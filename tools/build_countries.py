...
COUNTRIES = {
    ...
    # ---- North America: dependencies & overseas territories ----
    ...
    # Antarctica. AQ is not a country and has no sovereign: ISO 3166 and the
    # Antarctic Treaty both draw the line at 60°S and no claim south of it is
    # recognised, so every place down there gets this one code regardless of
    # whose flag flies over the hut. The four rows under it are the
    # sub-Antarctic islands, which are north of 60°S, do have sovereigns, and
    # therefore keep their own codes.
