...
CAM_WORDS_BY_COUNTRY = {
    ...
    "ecuador": ["cámara en vivo"], "venezuela": ["cámara en vivo"],
    "bolivia": ["cámara en vivo"], "uruguay": ["cámara en vivo"],
    "paraguay": ["cámara en vivo"], "costa rica": ["cámara en vivo"],
    "cuba": ["cámara en vivo"], "suriname": ["live webcam"],
    "guyana": ["live webcam"], "belize": ["live webcam"],
