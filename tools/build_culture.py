...
ROWS = {
 ...
 # Pacific island states and territories. Every one of them has its own row in
 # data/countries.json, so every one of them has to have a row here too, or the
 # culture panel prints "Language —, Currency —" under a place that is otherwise
 # finished. The territories keep the sovereign power's currency and plug but
 # their own language, dish and greeting — that is the part of them a traveller
 # actually meets.
 "Papua New Guinea": ("PG","PGK","Papua New Guinean kina (K)","Tok Pisin / English / Hiri Motu","Mumu — pork, kaukau & greens in an earth oven",
   [["Hello","Gude"],["Thank you","Tenkyu tru"],["Cheers","Amamas"]],"Port Moresby","10M","Right","Type I · 240V"),
 "Fiji": ("FJ","FJD","Fijian dollar (FJ$)","Fijian / English / Fiji Hindi","Kokoda — lime-cured fish in coconut milk",
   [["Hello","Bula"],["Thank you","Vinaka"],["Cheers","Bula!"]],"Suva","930K","Left","Type I · 240V"),
 "Solomon Islands": ("SB","SBD","Solomon Islands dollar (SI$)","English / Solomons Pijin","Fish in coconut milk with poi",
   [["Hello","Halo"],["Thank you","Tagio tumas"],["Cheers","Cheers"]],"Honiara","740K","Left","Type I · 220V"),
 "Vanuatu": ("VU","VUV","Vanuatu vatu (VT)","Bislama / English / French","Laplap — grated root baked in banana leaf",
   [["Hello","Halo"],["Thank you","Tankiu tumas"],["Cheers","Cheers"]],"Port Vila","330K","Right","Type I · 220V"),
 "New Caledonia": ("NC","XPF","CFP franc (₣)","French / 28 Kanak languages","Bougna — yam, taro & coconut milk baked in leaves",
   [["Hello","Bonjour"],["Thank you","Merci"],["Cheers","Santé"]],"Nouméa","270K","Right","Type C/E · 220V"),
 "Samoa": ("WS","WST","Samoan tālā (T$)","Samoan / English","Palusami & oka — taro leaves and raw fish in coconut cream",
   [["Hello","Tālofa"],["Thank you","Fa'afetai"],["Cheers","Manuia"]],"Apia","220K","Left","Type I · 230V"),
 "American Samoa": ("AS","USD","US dollar ($)","Samoan / English","Palusami & povi masima",
   [["Hello","Tālofa"],["Thank you","Fa'afetai"],["Cheers","Manuia"]],"Pago Pago","45K","Right","Type A/B · 120V"),
 "Tonga": ("TO","TOP","Tongan paʻanga (T$)","Tongan / English","ʻOta ʻika & lū pulu",
   [["Hello","Mālō e lelei"],["Thank you","Mālō ʻaupito"],["Cheers","Mālō"]],"Nukuʻalofa","105K","Left","Type I · 240V"),
 "Cook Islands": ("CK","NZD","New Zealand dollar (NZ$)","Cook Islands Māori / English","Ika mata — raw fish in coconut cream",
   [["Hello","Kia orana"],["Thank you","Meitaki"],["Cheers","Kia manuia"]],"Avarua","15K","Left","Type I · 240V"),
 "French Polynesia": ("PF","XPF","CFP franc (₣)","French / Tahitian","Poisson cru (ʻia ota) & poe",
   [["Hello","Ia ora na"],["Thank you","Māuruuru"],["Cheers","Manuia"]],"Papeete","280K","Right","Type C/E · 220V"),
 "Niue": ("NU","NZD","New Zealand dollar (NZ$)","Niuean / English","Takihi — pawpaw and taro baked in coconut cream",
   [["Hello","Fakalofa lahi atu"],["Thank you","Fakaaue lahi"],["Cheers","Kia monuina"]],"Alofi","1.9K","Left","Type I · 240V"),
 "Kiribati": ("KI","AUD","Australian dollar (A$)","Gilbertese / English","Coconut-braised reef fish & breadfruit",
   [["Hello","Mauri"],["Thank you","Ko rabwa"],["Cheers","Mauri"]],"South Tarawa","130K","Left","Type I · 240V"),
 "Tuvalu": ("TV","AUD","Australian dollar (A$)","Tuvaluan / English","Pulaka & coconut-poached fish",
   [["Hello","Tālofa"],["Thank you","Fakafetai"],["Cheers","Manuia"]],"Funafuti","11K","Left","Type I · 240V"),
 "Nauru": ("NR","AUD","Australian dollar (A$)","Nauruan / English","Coconut fish & pandanus",
   [["Hello","Ekamowir omo"],["Thank you","Tubwa kor"],["Cheers","Cheers"]],"Yaren","12K","Left","Type I · 240V"),
 "Palau": ("PW","USD","US dollar ($)","Palauan / English","Taro, reef fish & tinola",
   [["Hello","Alii"],["Thank you","Sulang"],["Cheers","Alii"]],"Ngerulmud","18K","Right","Type A/B · 120V"),
 "Marshall Islands": ("MH","USD","US dollar ($)","Marshallese / English","Breadfruit, reef fish & coconut",
   [["Hello","Iakwe"],["Thank you","Kommol tata"],["Cheers","Iakwe"]],"Majuro","42K","Right","Type A/B · 120V"),
 "Guam": ("GU","USD","US dollar ($)","English / CHamoru","Kelaguen & red rice",
   [["Hello","Håfa adai"],["Thank you","Si Yu'os ma'åse'"],["Cheers","Biba!"]],"Hagåtña","170K","Right","Type A/B · 110V"),
 "Northern Mariana Islands": ("MP","USD","US dollar ($)","English / CHamoru / Carolinian","Kelaguen & apigigi",
   [["Hello","Håfa adai"],["Thank you","Si Yu'os ma'åse'"],["Cheers","Biba!"]],"Saipan","47K","Right","Type A/B · 120V"),
 "Norfolk Island": ("NF","AUD","Australian dollar (A$)","English / Norf'k","Pilhi — banana or pumpkin baked flat",
   [["Hello","Watawieh"],["Thank you","Thank yorlye"],["Cheers","Cheers"]],"Kingston","2.2K","Left","Type I · 240V"),
 "Pitcairn Islands": ("PN","NZD","New Zealand dollar (NZ$)","English / Pitkern","Pilhi & breadfruit",
   [["Hello","Whata way ye"],["Thank you","Thank ye"],["Cheers","Cheers"]],"Adamstown","35","Left","Type I · 240V"),
 # ---------- Latin America ----------
 ...
 # ---------- Central America & the Caribbean (2026-08-19 batch) ----------
 # 31 countries and territories that arrived with build_middleamerica.py and
 # build_caribbean.py. Half of them are dependencies, which is where the sloppy
 # rows hide: the currency is often NOT the metropole's (Martinique is on the
 # euro, Curaçao is not on the Dutch one), and the driving side frequently
 # disagrees with the flag on the pole — the USVI and the BVI drive on the LEFT
 # with American cars, and Saint-Martin and Sint Maarten drive on the RIGHT on
 # the same 87 km² island. Check each one, don't inherit from the sovereign.
 "Guatemala": ("GT","GTQ","Guatemalan quetzal (Q)","Spanish","Pepián & tamales",
   [["Hello","Hola"],["Thank you","Gracias"],["Cheers","Salud"]],"Guatemala City","18M","Right","Type A/B · 120V"),
 "El Salvador": ("SV","USD","US dollar ($)","Spanish","Pupusas",
   [["Hello","Hola"],["Thank you","Gracias"],["Cheers","Salud"]],"San Salvador","6.4M","Right","Type A/B · 115V"),
 "Honduras": ("HN","HNL","Honduran lempira (L)","Spanish","Baleadas",
   [["Hello","Hola"],["Thank you","Gracias"],["Cheers","Salud"]],"Tegucigalpa","10.6M","Right","Type A/B · 110V"),
 "Nicaragua": ("NI","NIO","Nicaraguan córdoba (C$)","Spanish","Gallo pinto & nacatamal",
   [["Hello","Hola"],["Thank you","Gracias"],["Cheers","Salud"]],"Managua","7.0M","Right","Type A/B · 120V"),
 "Panama": ("PA","PAB","Panamanian balboa (B/.) — US notes circulate","Spanish","Sancocho & ropa vieja",
   [["Hello","Hola"],["Thank you","Gracias"],["Cheers","Salud"]],"Panama City","4.5M","Right","Type A/B · 110V"),
 "Jamaica": ("JM","JMD","Jamaican dollar (J$)","English / Patois","Ackee & saltfish, jerk chicken",
   [["Hello","Hello / Wah gwaan"],["Thank you","Thank you / Respect"],["Cheers","Cheers"]],"Kingston","2.8M","Left","Type A/B · 110V"),
 "Haiti": ("HT","HTG","Haitian gourde (G)","Haitian Creole / French","Griot & diri ak djon djon",
   [["Hello","Bonjou"],["Thank you","Mèsi"],["Cheers","Sante"]],"Port-au-Prince","11.7M","Right","Type A/B · 110V"),
 "Dominican Republic": ("DO","DOP","Dominican peso (RD$)","Spanish","La bandera & mangú",
   [["Hello","Hola"],["Thank you","Gracias"],["Cheers","Salud"]],"Santo Domingo","11.3M","Right","Type A/B · 110V"),
 "Trinidad and Tobago": ("TT","TTD","Trinidad & Tobago dollar (TT$)","English","Doubles & callaloo",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Port of Spain","1.4M","Left","Type A/B · 115V"),
 "Barbados": ("BB","BBD","Barbadian dollar (Bds$)","English / Bajan","Cou-cou & flying fish",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Bridgetown","282K","Left","Type A/B · 115V"),
 "Saint Lucia": ("LC","XCD","East Caribbean dollar (EC$)","English / Kwéyòl","Green fig & saltfish",
   [["Hello","Hello / Bonjou"],["Thank you","Thank you / Mèsi"],["Cheers","Cheers"]],"Castries","180K","Left","Type G · 240V"),
 "Saint Vincent and the Grenadines": ("VC","XCD","East Caribbean dollar (EC$)","English","Roasted breadfruit & fried jackfish",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Kingstown","104K","Left","Type G · 230V"),
 "Grenada": ("GD","XCD","East Caribbean dollar (EC$)","English","Oil down",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"St. George's","125K","Left","Type G · 230V"),
 "Antigua and Barbuda": ("AG","XCD","East Caribbean dollar (EC$)","English","Fungee & pepperpot",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"St. John's","94K","Left","Type A/B/G · 230V"),
 "Dominica": ("DM","XCD","East Caribbean dollar (EC$)","English / Kwéyòl","Mountain chicken & callaloo",
   [["Hello","Hello / Bonjou"],["Thank you","Thank you / Mèsi"],["Cheers","Cheers"]],"Roseau","73K","Left","Type D/G · 230V"),
 "Saint Kitts and Nevis": ("KN","XCD","East Caribbean dollar (EC$)","English","Stewed saltfish with dumplings",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Basseterre","48K","Left","Type A/B/D/G · 230V"),
 "Anguilla": ("AI","XCD","East Caribbean dollar (EC$)","English","Crayfish & pigeon peas",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"The Valley","16K","Left","Type A/B · 110V"),
 "Montserrat": ("MS","XCD","East Caribbean dollar (EC$)","English","Goat water stew",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Brades","4.4K","Left","Type A/B · 230V"),
 "Puerto Rico": ("PR","USD","US dollar ($)","Spanish / English","Mofongo & lechón",
   [["Hello","Hola"],["Thank you","Gracias"],["Cheers","Salud"]],"San Juan","3.2M","Right","Type A/B · 120V"),
 "United States Virgin Islands": ("VI","USD","US dollar ($)","English","Fish & fungi",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Charlotte Amalie","87K","Left","Type A/B · 110V"),
 "British Virgin Islands": ("VG","USD","US dollar ($)","English","Fish & fungi, roti",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Road Town","32K","Left","Type A/B · 110V"),
 "Cayman Islands": ("KY","KYD","Cayman Islands dollar (CI$)","English","Cayman-style beef & conch stew",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"George Town","74K","Left","Type A/B · 120V"),
 "Turks and Caicos Islands": ("TC","USD","US dollar ($)","English","Cracked conch & peas 'n' grits",
   [["Hello","Hello"],["Thank you","Thank you"],["Cheers","Cheers"]],"Cockburn Town","46K","Left","Type A/B · 120V"),
 "Aruba": ("AW","AWG","Aruban florin (Afl.)","Dutch / Papiamento","Keshi yena",
   [["Hello","Bon dia"],["Thank you","Danki"],["Cheers","Salú"]],"Oranjestad","108K","Right","Type A/B · 127V"),
 "Curaçao": ("CW","XCG","Caribbean guilder (Cg)","Dutch / Papiamentu","Keshi yena & stoba",
   [["Hello","Bon dia"],["Thank you","Danki"],["Cheers","Salú"]],"Willemstad","155K","Right","Type A/B · 127V"),
 "Bonaire": ("BQ","USD","US dollar ($)","Dutch / Papiamentu","Kabritu stoba",
   [["Hello","Bon dia"],["Thank you","Danki"],["Cheers","Salú"]],"Kralendijk","24K","Right","Type A/B · 127V"),
 "Sint Maarten": ("SX","XCG","Caribbean guilder (Cg)","Dutch / English","Johnny cakes & guavaberry",
   [["Hello","Hello / Bon dia"],["Thank you","Thank you / Danki"],["Cheers","Proost"]],"Philipsburg","44K","Right","Type A/B · 110V"),
 "Saint Martin": ("MF","EUR","Euro (€)","French / Creole","Colombo & johnny cakes",
   [["Hello","Bonjour"],["Thank you","Merci"],["Cheers","Santé"]],"Marigot","32K","Right","Type C/E · 220V"),
 "Saint Barthélemy": ("BL","EUR","Euro (€)","French","Accras & grilled langouste",
   [["Hello","Bonjour"],["Thank you","Merci"],["Cheers","Santé"]],"Gustavia","11K","Right","Type C/E · 220V"),
 "Martinique": ("MQ","EUR","Euro (€)","French / Creole","Colombo de poulet & accras",
